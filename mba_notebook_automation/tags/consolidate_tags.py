...
This script consolidates multiple tags in notes to a single, most specific nested tag.
It analyzes the current tag structure in each note, determines the most appropriate
single hierarchical tag based on the MBA tag structure, and updates the frontmatter.

The script helps maintain a cleaner tagging strategy by ensuring each note has just
one descriptive hierarchical tag rather than multiple tags.
...
Args:
    ...
    --keep-structural: Keep structural tags (index/, structure/) in addition to the main tag
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Consolidate multiple tags to a single tag per file")
    parser.add_argument('--vault', type=str, help='Path to the Obsidian vault')
    parser.add_argument('--dry-run', action='store_true', help='Show what would be changed without modifying files')
    parser.add_argument('--debug', action='store_true', help='Enable debug logging')
    parser.add_argument('--keep-structural', action='store_true', help='Keep structural tags (index/, structure/)')
    parser.add_argument('--priority', type=str, choices=['course', 'skill', 'type', 'tool'], 
                      default='course', help='Tag category to prioritize (default: course)')
