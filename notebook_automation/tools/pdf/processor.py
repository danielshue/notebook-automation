...
Usage Example:
-------------```python
from notebook_automation.tools.pdf.processor import extract_pdf_text, get_pdf_metadata, clean_pdf_text
...
from notebook_automation.tools.ai.summarizer import generate_summary
