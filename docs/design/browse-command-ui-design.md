...
- [x] Create `FileBrowserUI` with basic navigation
- [x] Implement `VaultBrowserSource` wrapping `VaultBrowserService`
- [x] Add `browse vault` command to `ChatBuiltInCommands`
- [x] Basic file listing and navigation

### Phase 2: File Operations

- [x] File preview/read functionality
- [x] Tag management integration
- [x] File creation and deletion
- [x] Edit file (launch external editor)
