...
namespace NotebookAutomation.Core.Tests
{
    ...
    public class AISummarizerWithKernelTests
    {
        ...
        public void SetUp()
        {
            ...
            _mockPromptService
                ...
                .Returns((string template, Dictionary<string, string>? vars) =>
                {
                    ...
                    if (vars != null && vars.ContainsKey("content"))
                    {
                        result = template.Replace("{{content}}", vars["content"]);
                    }
        ...
        public async Task SummarizeWithVariablesAsync_WithRealKernel_ProcessesCorrectly()
        {
            ...
            var kernel = TestKernelHelper.CreateKernelWithSimulatedResponse(expectedSummary);
        ...
        public async Task SummarizeWithVariablesAsync_LargeText_UsesSemanticKernel()
        {
            ...
            var kernel = MockKernelFactory.CreateKernelForChunkingTests(expectedSummary);
            ...
            string largeText = new string('X', 50000);
