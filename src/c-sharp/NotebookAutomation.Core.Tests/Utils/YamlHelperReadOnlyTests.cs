...
/// </summary>
[TestClass]
internal class YamlHelperReadOnlyTests
{
    ...
    public void IsAutoGeneratedStateReadOnly_WithReadOnlyState_ReturnsTrue()
    {
        ...
        // Act
        bool result = this.yamlHelper!.IsAutoGeneratedStateReadOnly(frontmatter);
    ...
    public void IsAutoGeneratedStateReadOnly_WithMixedCase_ReturnsTrue()
    {
        ...
        // Act
        bool resultReadOnly = this.yamlHelper!.IsAutoGeneratedStateReadOnly(frontmatterReadOnly);
        bool resultReadonly = this.yamlHelper!.IsAutoGeneratedStateReadOnly(frontmatterReadonly);
...
This is a test document.";
        ...
        string testFilePath = Path.Combine(this.tempDir!, "readonly-test.md");
        File.WriteAllText(testFilePath, testMarkdown, Encoding.UTF8);

        // Act
        bool result = this.yamlHelper!.IsFileReadOnly(testFilePath);
...
This is a test document.";
        ...
        string testFilePath = Path.Combine(this.tempDir!, "draft-test.md");
        File.WriteAllText(testFilePath, testMarkdown, Encoding.UTF8);
    ...
    {
        // Arrange
        string nonExistentPath = Path.Combine(this.tempDir!, "nonexistent.md");

        // Act
        bool result = this.yamlHelper!.IsFileReadOnly(nonExistentPath);
...
This is a test document without frontmatter.";
        ...
        string testFilePath = Path.Combine(this.tempDir!, "no-frontmatter-test.md");
        File.WriteAllText(testFilePath, testMarkdown, Encoding.UTF8);
