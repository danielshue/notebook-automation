...
date-created: 2025-04-19";
        ...
        appConfigMock = new Mock<AppConfig>();
    ...
    {
        // Arrange
        MetadataTemplateManager templateManager = new(loggerMock.Object, testAppConfig, yamlHelperMock.Object);
