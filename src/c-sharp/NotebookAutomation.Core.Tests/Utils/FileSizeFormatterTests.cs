...
namespace NotebookAutomation.Core.Tests.Utils
{
    ...
    public class FileSizeFormatterTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void FormatFileSizeToString_Bytes()
        {
            Assert.AreEqual("512.00 B", FileSizeFormatter.FormatFileSizeToString(512));
        }
        ...
        /// </summary>
        [TestMethod]
        public void FormatFileSizeToString_Kilobytes()
        {
            Assert.AreEqual("1.00 KB", FileSizeFormatter.FormatFileSizeToString(1024));
        }
        ...
        /// </summary>
        [TestMethod]
        public void FormatFileSizeToString_Megabytes()
        {
            Assert.AreEqual("1.00 MB", FileSizeFormatter.FormatFileSizeToString(1024 * 1024));
        }
        ...
        /// </summary>
        [TestMethod]
        public void FormatFileSizeToString_Gigabytes()
        {
            Assert.AreEqual("1.00 GB", FileSizeFormatter.FormatFileSizeToString(1024L * 1024 * 1024));
        }
        ...
        /// </summary>
        [TestMethod]
        public void FormatFileSizeToString_Terabytes()
        {
            Assert.AreEqual("1.00 TB", FileSizeFormatter.FormatFileSizeToString(1024L * 1024 * 1024 * 1024));
        }
