...
public partial class MarkdownParser(ILogger logger)
{
    ...
    private static partial Regex YamlFrontmatterRegexImpl();

    /// <summary>Gets a compiled regex that matches YAML frontmatter blocks.</summary>
    public static Regex YamlFrontmatterRegex() => YamlFrontmatterRegexImpl();
    ...
    /// </remarks>
    [GeneratedRegex(@"^(#+)\s+(.+)$")]
    private static partial Regex MarkdownHeaderRegexImpl();

    /// <summary>Gets a compiled regex that matches markdown headers.</summary>
    public static Regex MarkdownHeaderRegex() => MarkdownHeaderRegexImpl();
