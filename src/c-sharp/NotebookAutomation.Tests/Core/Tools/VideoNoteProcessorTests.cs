...
public class VideoNoteProcessorTests
{
    ...
    {
        // Arrange
        Mock<ILogger<VideoNoteProcessor>> loggerMock = new Mock<ILogger<VideoNoteProcessor>>(); var appConfig = new AppConfig
        {
        ...
        AISummarizer aiSummarizer = new(
            ...
            promptService,
            null);
        Mock<IYamlHelper> yamlHelperMock = new Mock<IYamlHelper>();
