...
from tools.utils.config import RESOURCES_ROOT, VAULT_ROOT, METADATA_FILE, ONEDRIVE_BASE, VIDEO_EXTENSIONS, logger, setup_logging
...
def main():
    ...
    main_logger.info(f"RESOURCES_ROOT: {RESOURCES_ROOT}")
    main_logger.info(f"VAULT_ROOT: {VAULT_ROOT}")
